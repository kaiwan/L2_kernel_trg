...
MODULE_DESCRIPTION("A quick kmalloc/ksize test; shows how kernel memory can get wasted \
by using poorly thought-out amounts");

static int stepsz=10000;
module_param(stepsz, int, 0);
MODULE_PARM_DESC(stepsz, "Number of bytes to increment each kmalloc attempt by (default=10000)");
